 ...
 */
@TargetApi(16)
public abstract class MediaCodecTrackRenderer2 extends SampleSourceTrackRenderer {

  /**
   * Interface definition for a callback to be notified of {@link MediaCodecTrackRenderer2} events.
   */
   ...
   */
  public MediaCodecTrackRenderer2(SampleSource source, MediaCodecSelector mediaCodecSelector,
   ...
   * @param eventListener A listener of events. May be null if delivery of events is not required.
   */
  public MediaCodecTrackRenderer2(SampleSource[] sources, MediaCodecSelector mediaCodecSelector,
                                  DrmSessionManager<FrameworkMediaCrypto> drmSessionManager,
                                  boolean playClearSamplesWithoutKeys, Handler eventHandler, EventListener eventListener) {
    super(sources);
