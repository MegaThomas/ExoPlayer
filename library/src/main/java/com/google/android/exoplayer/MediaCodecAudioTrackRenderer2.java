 ...
 */
@TargetApi(16)
public class MediaCodecAudioTrackRenderer2 extends MediaCodecTrackRenderer implements MediaClock {

  /**
   * Interface definition for a callback to be notified of {@link MediaCodecAudioTrackRenderer2}
   * events.
   */
   ...
   */
  public MediaCodecAudioTrackRenderer2(SampleSource source, MediaCodecSelector mediaCodecSelector) {
   ...
   * @param streamType The type of audio stream for the {@link AudioTrack}.
   */
  public MediaCodecAudioTrackRenderer2(SampleSource[] sources, MediaCodecSelector mediaCodecSelector,
                                       DrmSessionManager drmSessionManager, boolean playClearSamplesWithoutKeys,
                                       Handler eventHandler, EventListener eventListener, AudioCapabilities audioCapabilities,
                                       int streamType) {
