 ...
 */
@TargetApi(16)
public final class TextTrackRenderer2 extends SampleSourceTrackRenderer implements Callback {
   ...
   */
  public TextTrackRenderer2(SampleSource source, TextRenderer textRenderer,
   ...
   *     priority. If omitted, the default parsers will be used.
   */
  public TextTrackRenderer2(SampleSource[] sources, TextRenderer textRenderer,
                            Looper textRendererLooper, SubtitleParser... subtitleParsers) {
    super(sources);
