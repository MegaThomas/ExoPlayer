 ...
 */
@TargetApi(16)
public class MediaCodecVideoTrackRenderer2 extends MediaCodecTrackRenderer {

  /**
   * Interface definition for a callback to be notified of {@link MediaCodecVideoTrackRenderer2}
   * events.
   */
   ...
   */
  public MediaCodecVideoTrackRenderer2(Context context, SampleSource source,
