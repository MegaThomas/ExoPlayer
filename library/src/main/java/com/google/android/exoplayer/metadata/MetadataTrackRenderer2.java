 ...
 */
public final class MetadataTrackRenderer2<T> extends SampleSourceTrackRenderer implements Callback {
   ...
   */
  public MetadataTrackRenderer2(SampleSource source, MetadataParser<T> metadataParser,
